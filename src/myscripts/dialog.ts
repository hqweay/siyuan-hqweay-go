/*
 * https://github.com/frostime/siyuan-plugin-kits/blob/730990af210f005caba059276490d622084018f6/src/dialog.ts
...
export const inputDialog = (args: {
            ...
            <div class="ft__breakword fn__flex fn__flex-1" style="height: 100%;">
                ${
                  args.type === "textarea"
                    ...
                    : `<input class="b3-text-field fn__flex-center" style="flex: 1; font-size: ${
                        args.fontSize || "17px"
  ...
  const inputElement = dialog.element.querySelector("textarea, input") as
    | HTMLTextAreaElement
    | HTMLInputElement;
