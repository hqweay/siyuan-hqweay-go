...
class RandomNotePlugin extends AddIconThenClick implements SubPlugin {
  ...
  // 打开随机文档，编辑sql选定范围
  async exec() {
    console.log("randomNote exec" + this.cacheIds);
...
export default RandomNotePlugin;
