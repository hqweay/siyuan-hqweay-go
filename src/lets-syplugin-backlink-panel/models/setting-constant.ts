  ...
  tabProperties.push(
    new TabProperty({
      ...
      props: [
        ...
        new ItemProperty({
          key: "cacheAfterResponseMs",
          type: "number",
          name: "启用缓存门槛（毫秒）",
          description:
            "当接口响应时间超过这个数，就会把这次查询结果存入缓存，-1 不开启缓存",
          tips: "",
          min: -1,
        }),
        new ItemProperty({
        ...
        new ItemProperty({
          key: "documentBottomBacklinkPaddingWidth",
          type: "number",
          name: "文档底部反链面板左右间距",
          description: "为空则跟文档宽度一致。",
          tips: "",
        }),
      ],
    }),
    new TabProperty({
      key: "filter-panel-setting",
      name: "筛选面板",
      iconKey: "iconFilter",
      props: [
        new ItemProperty({
          key: "filterPanelViewExpand",
          type: "switch",
          name: "默认展开筛选面板",
          description: "",
          tips: "",
        ...
        new ItemProperty({
          key: "querrChildDefBlockForListItem",
          type: "switch",
          name: "查询列表项下关联定义块",
          description:
            "如果反链块的父级是列表项块，则查询该列表项块底下的所有定义块",
          tips: "",
        }),
        new ItemProperty({
          key: "queryChildDefBlockForHeadline",
          type: "switch",
          name: "查询标题下关联定义块",
          description: "如果反链块是标题块，则查询标题下的所有定义块",
          tips: "",
        }),

        new ItemProperty({
          key: "filterPanelCurDocDefBlockSortMethod",
          type: "select",
          name: "当前文档定义块排序方式",
          description: "",
          tips: "",
          options: geturDocDefBlockSortMethodElement(),
        }),
        new ItemProperty({
          key: "filterPanelRelatedDefBlockSortMethod",
          type: "select",
          name: "关联定义块排序方式",
          description: "",
          tips: "",
          options: getRelatedDefBlockSortMethodElement(),
        }),
        new ItemProperty({
          key: "filterPanelBacklinkDocumentSortMethod",
          type: "select",
          name: "关联文档排序方式",
          description: "",
          tips: "",
          options: getRelatedDocmumentSortMethodElement(),
        }),
      ],
    }),
    new TabProperty({
      ...
      props: [
        new ItemProperty({
          key: "docBottomBacklinkPanelViewExpand",
          type: "switch",
          name: "文档底部默认展开反链面板",
          description: "",
          tips: "",
        ...
        new ItemProperty({
          ...
          type: "number",
          name: "每页反链块数量",
          description: "每页反链块显示的数量",
          tips: "",
          min: 1,
          max: 50,
        }),
        new ItemProperty({
          key: "backlinkBlockSortMethod",
          type: "select",
          name: "反链块排序方式",
          description: "",
          tips: "",
          options: getBacklinkBlockSortMethodOptions(),
        }),
        new ItemProperty({
          key: "defaultExpandedListItemLevel",
          type: "number",
          name: "默认展开列表项层数",
          description: "如果反链所在是列表项，默认展开的子列表深度。",
          tips: "",
          min: 0,
          max: 10,
        }),
